...
Staff.belongsTo(School, { foreignKey: { name: 'school_id', allowNull: false }, targetKey: 'school_id' });
School.hasMany(Staff, { foreignKey: { name: 'school_id', allowNull: false }, sourceKey: 'school_id' });
